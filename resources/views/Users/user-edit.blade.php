                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form class="needs-validation" action="{{ route('update_user') }}" method="POST">
                                @csrf
                                ...
                                <div class="card-body">
                                    ...
                                    $decryption_password = openssl_decrypt($encrypt_password, $ciphering, $decryption_key, $options, $decryption_iv);
                        ...
                        @endphp --}}
                                        ...
                                        {{-- <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select @error('role') is-invalid @enderror"
                                                    ...
                                                    <option value="staff" {{ $data->role == 'staff' ? 'selected' : '' }}>
                                                        Staff
                                                    </option>
                                                </select>
                                                @error('role')
                                ...
                                <div class="card-footer text-right">
                                    {{-- <button class="btn btn-dark mr-1 my-2" type="reset"><i
