...
@section('title', 'Add Wordpress User')
@section('content')
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 d-flex">
                     <a href="{{route('wordpress_user')}}" class=""><i class="fa-solid fa-arrow-left fa-1x my-1 text-dark"></i>
                        </a>
                        ...
                        <div class="card">
                            {{-- <div class="card-header">
                                <div class="text-right">
                                    <a href="/wordpress-users" class="btn btn-warning btn-sm"><i
                            ...
                            <form class="needs-validation" action="{{ route('insert_wordpress_user') }}" method="POST">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                             ...
                                             class="form-control @error('name') is-invalid @enderror" id="name" value="wordpress user" hidden>
