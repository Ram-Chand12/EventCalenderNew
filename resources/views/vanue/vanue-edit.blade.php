...
@section('title', 'Edit Venue ' . $vanue->name)
@section('content')
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 d-flex">
                        <a href="{{route('vanue')}}" class=""><i class="fa-solid fa-arrow-left fa-2x text-dark"></i>
                        </a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form class="needs-validation" action="{{ route('vanue-updates') }}" method="POST">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name"
                                                    ...
                                                    placeholder="Name" value="{{ $vanue->name }}" required>
                                                @error('name')
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="vanue_description"
                                                    ...
                                                    id="vanue_description" placeholder="vanue_description "
                                                    value="{{ $vanue->vanue_description }}">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="city"
                                                    ...
                                                    placeholder="city " value="{{ $vanue->city }}" required>
                                                @error('city')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                                ...
                                                <select class="form-select @error('country') is-invalid @enderror"
                                                    ...
                                                    @foreach ($countries as $country)
                                                        <option value="{{ $country->country_name }}"
                                                            {{ $vanue->country == $country->id ? 'selected' : '' }}>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select @error('state') is-invalid @enderror"
                                                    ...
                                                    @foreach ($states as $state)
                                                        <option value="{{ $state->Name }}" {{$vanue->state === $state->Name ? 'selected' : ''}}>{{ $state->Name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('state')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="postal_code" class="field_required">postal_code</label>
                                                <input type="number" name="postal_code"
                                                    class="form-control @error('postal_code') is-invalid @enderror"
                                                    id="postal_code" placeholder="Postal code"
                                                    value="{{ $vanue->postal_code }}" required maxlength="6">
                                                @error('postal_code')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="phone"
                                                    ...
                                                    id="phone" placeholder="phone " value="{{ $vanue->phone }}"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="website"
                                                    ...
                                                    id="website" placeholder="website " value="{{ $vanue->website }}"
                                                    required>
                                                @error('website')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="address"
                                                    ...
                                                    id="address" placeholder="address " value="{{ $vanue->address }}"
                                                    required>
                                                @error('address')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" name="status"
                                                        ...
                                                        id="status" {{ $vanue->status == true ? 'checked' : '' }}>
